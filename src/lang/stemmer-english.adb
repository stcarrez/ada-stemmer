...
package body Stemmer.English is
   ...
   procedure rU_Step_5 (Z : in out Context_Type; Result : out Boolean);
   procedure rU_Step_4 (Z : in out Context_Type; Result : out Boolean);
   procedure rU_Step_3 (Z : in out Context_Type; Result : out Boolean);
   procedure rU_Step_2 (Z : in out Context_Type; Result : out Boolean);
   procedure rU_Step_1c (Z : in out Context_Type; Result : out Boolean);
   procedure rU_Step_1b (Z : in out Context_Type; Result : out Boolean);
   procedure rU_Step_1a (Z : in out Context_Type; Result : out Boolean);
   ...
   glUUU_v_WXY : constant Grouping_Array (0 .. 39) := (
      True, False, False, False, False, False, False, False,
      True, False, False, False, True, False, False, False,
      True, False, False, False, False, False, True, False,
   ...
   glllllUU_valid_LI : constant Grouping_Array (0 .. 23) := (
   ...
   begin
      ...
      v_1 := Z.L - Z.C;
      --  (, line 50
      Out_Grouping_Backward (Z, glUUU_v_WXY, 89, 121, False, C);
      if C /= 0 then
         goto lab1;
      end if;
   ...
   procedure rU_Step_1a (Z : in out Context_Type; Result : out Boolean) is
      C : Integer;
      A : Integer;
      v_1 : Integer;
      v_2 : Integer;
   ...
   procedure rU_Step_1b (Z : in out Context_Type; Result : out Boolean) is
      C : Integer;
      A : Integer;
      v_1 : Integer;
      v_3 : Integer;
   ...
   procedure rU_Step_1c (Z : in out Context_Type; Result : out Boolean) is
      C : Integer;
      A : Integer;
      v_1 : Integer;
   begin
   ...
   procedure rU_Step_2 (Z : in out Context_Type; Result : out Boolean) is
      C : Integer;
      A : Integer;
   begin
      --  (, line 99
      ...
      case A is
         ...
         when 15 =>
            --  (, line 122
            In_Grouping_Backward (Z, glllllUU_valid_LI, 99, 116, False, C);
            if C /= 0 then
               Result := False;
               return;
            end if;
   ...
   procedure rU_Step_3 (Z : in out Context_Type; Result : out Boolean) is
      C : Integer;
      A : Integer;
   begin
      --  (, line 126
   ...
   procedure rU_Step_4 (Z : in out Context_Type; Result : out Boolean) is
      C : Integer;
      A : Integer;
      v_1 : Integer;
   begin
   ...
   procedure rU_Step_5 (Z : in out Context_Type; Result : out Boolean) is
      C : Integer;
      A : Integer;
      v_1 : Integer;
      v_2 : Integer;
