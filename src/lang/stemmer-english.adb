...
package body Stemmer.English is
   ...
   begin
      ...
      --  substring, line 60
      if Z.C <= Z.Lb or else (Character'Pos (Z.P (Z.C - 1)) /= 39 and then Character'Pos (Z.P (Z.C - 1)) /= 115) then
         Z.C := Z.L - v_1;
         goto lab0;
         --  substring, line 60
      end if;
      ...
      --  substring, line 65
      if Z.C <= Z.Lb or else (Character'Pos (Z.P (Z.C - 1)) /= 100 and then Character'Pos (Z.P (Z.C - 1)) /= 115) then
         Result := False;
         return;
         --  substring, line 65
      end if;
   ...
   begin
      ...
      --  substring, line 150
      if Z.C <= Z.Lb or else (Character'Pos (Z.P (Z.C - 1)) /= 101 and then Character'Pos (Z.P (Z.C - 1)) /= 108) then
         Result := False;
         return;
         --  substring, line 150
      end if;
   ...
   begin
      ...
      --  substring, line 158
      if Z.C - 5 <= Z.Lb or else (Character'Pos (Z.P (Z.C - 1)) /= 100 and then Character'Pos (Z.P (Z.C - 1)) /= 103) then
         Result := False;
         return;
         --  substring, line 158
      end if;
